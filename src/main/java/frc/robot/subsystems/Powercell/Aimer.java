...
public class Aimer extends SubsystemBase {
  ...
  private SupplyCurrentLimitConfiguration supplyCurrentLimitConfiguration = new SupplyCurrentLimitConfiguration(true, 10, 15, 1);
  //單位正，向後
   ...
   */
  public Aimer() { 
    aimer.configSupplyCurrentLimit(supplyCurrentLimitConfiguration);
  ...
  public void resetAimer(){
    aimer.setSelectedSensorPosition(0, 12000,10);
  }
  public void Uplimit(){
